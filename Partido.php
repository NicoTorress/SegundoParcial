...
class Partido{
 ...
 public function setObjEquipo1($objEquipo1){
    ...
    public function darEquipoGanador(){
        ...
        $equipoGanador = $this->retornarCadena($equipoGanador);        
        return $equipoGanador;
    }

    public function coeficientePartido(){
        $cantGolesEnTotal = $this->getCantGolesE1() + $this->cantGolesE2();
        $jugadoresTotal = ($this->getObjEquipo1()->getCantJugadores()) + $this->getObjEquipo2()->getCantJugadores();
        $valorCoef = $this->getCoefBase() * $cantGolesEnTotal * $jugadoresTotal;
        return $valorCoef;
    }
